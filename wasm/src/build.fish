...
em++ index.cpp $LAME_OBJ -o ../mp3paper.js \
    -I ../../include -I lame/ -I lame/libmp3lame \
    -O3 -Wall -Wextra -Wpedantic -Wshadow \
    -s MODULARIZE=1 -s EXPORT_ES6=1 \
    -s WASM=1 \
    -s EXPORTED_FUNCTIONS='["_malloc", "_free", "_examplefunc1", "_examplefunc2"]' \
